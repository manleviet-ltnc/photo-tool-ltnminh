...
namespace MyPhotos
{
    public partial class MainForm : Form
    {
        ...
        private void mnuEditAdd_Click(object sender, EventArgs e)
        {
            ...
            dlg.Filter = "Image Files (JPEG, GIF, BMP, etc.)*.jpg; *.jpeg;*.gif;*.bmp;*.tiff;*.png|" + "JPEG files (*.jpg;*.jpeg)|*.jpg;*.jpeg|" + "GIF files (*.gif)|*.gif|" + "BMP files (*.bmp)|*.bmp|" + "TIFF files (*.tif;*.tiff)|*.tif;*.tiff|" + "PNG files (*.png)|*.png|" + "ALL files (*.*)|*.*;";
