...
namespace Manning.MyPhotoControls
{
    ...
    public class ScrollablePictureBox : PictureBox
    {
        ...
        {
            Rectangle targerRect = new Rectangle(0, 0, Math.Min(Right - VBar.Width, Image.Width), Math.Min(Bottom - HBar.Height, Image.Height));
            Rectangle sourceRect = new Rectangle(HBar.Value, VBar.Value, Math.Min(Right - VBar.Width, Image.Width), Math.Min(Bottom - HBar.Height, Image.Height));
